...
export const submissions = sqliteTable("submissions", {
  ...
  abstractNative: text("abstract_native"),
  abstractNativeLanguage: text("abstract_native_language"),
  submissionType: text("submission_type").notNull().default("article"),
  dataSourceUrl: text("data_source_url"),
  codeUrl: text("code_url"),
  callSlug: text("call_slug"),
  ...
  guardianEmailUpdatedAt: text("guardian_email_updated_at"),
