...
export default async function RecruitmentPage() {
  ...
  return (
    <main className="editor-page">
      <header className="editor-header"><div><p className="eyebrow">Private editorial workspace</p><h1>Recruitment desk</h1><p>Reviewer applications and program inquiries remain private to authorized editors.</p></div><div className="editor-header-actions"><Link href="/editor" className="editor-link">Submission desk</Link><Link href="/" className="editor-link">View public site</Link><Link href={editorSignOutPath("/")} className="editor-link">Sign out</Link></div></header>
