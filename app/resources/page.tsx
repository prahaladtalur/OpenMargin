...
export default function ResourcesPage() {
  return (
    <main>
      ...
      <section className="resource-cards"><article><p className="eyebrow">For authors</p><h2>Read the rubric first.</h2><p>These are the questions reviewers answer. Fix a gap before you send the paper.</p><Link className="text-link" href="/review">Read the rubric</Link></article><article><p className="eyebrow">For teachers and programs</p><h2>Let students choose.</h2><p>Share the checklist. Support revision. Let each student decide whether Open Margin fits.</p><Link className="text-link" href="/share">Share with students</Link></article><article><p className="eyebrow">For contributors</p><h2>Write a useful review.</h2><p>We need reviewers and advisors who can write specific, private, and fair comments.</p><Link className="text-link" href="/reviewers">Review with us</Link></article></section>
