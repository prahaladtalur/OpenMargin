...
const additions = [
  ...
  ["Schools and teachers", "A readiness checklist, a public rubric, and a free route for humanities, social science, and STEM work."],
  ...
  return (
    <main>
      <PageIntro
        ...
        description="Open Margin gives research and learning programs a free, independent route for eligible work to receive feedback and be considered for publication."
      />
      ...
      <section className="partner-model">
        ...
        <div className="partner-model-copy"><p>Open Margin is optional. It does not replace teaching, mentoring, research supervision, or a final presentation. Students submit directly, editorial decisions stay independent, and publication is never promised.</p><p>Open Margin is one option among others. Students can consider it alongside other journals or public venues. If the same work is under consideration elsewhere, they should tell us before submitting.</p><p>We read work about history, literature, economics, politics, society, technology, education, ethics, culture, science, mathematics, computing, and engineering. Specialized STEM work depends on having the right reviewer.</p></div>
      </section>
      ...
      <section className="submission-portal" id="inquire">
        <div className="portal-heading"><p className="eyebrow">Partner inquiry</p><h2>Tell us about your program.</h2><p>Share who you work with, which subjects matter, and what kind of work students make. We will reply if the idea fits our scope and current capacity.</p></div>
        <PartnerInquiryForm />
      </section>
    </main>
  );
